...
public class TxVideoPlayerController
    ...
    public void setRateController(){
        onRateController(mClarity);
    }

    List<String> mDialogList;
    //修改清晰度为倍速
    private void onRateController(TextView mClarity) {
        //清晰度 当做倍速 5.0 以上
...
//        mClarity.setText(mFloat + "X");
    ...
    private Float[] speedArr = {1.3f,1.15f,1.0f,0.85f,0.7f};
...
//        mClarity.setText(clarity.grade);
        //调整到dialog中
        mFloat = speedArr[clarityIndex];
        mClarity.setText(mFloat + "X");
        switchPlayVideoSpeed(mClarity);
